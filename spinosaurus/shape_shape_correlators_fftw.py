...
class ShapeShapeCorrelators(DensityShapeCorrelators):
    '''
    ...
    def __init__(self, *args, beyond_gauss = False, **kw):
        ...
        DensityShapeCorrelators.__init__(self, *args, **kw)
    ...
    def update_power_spectrum(self,k,p):
        ...
        '''
        super(ShapeShapeCorrelators,self).update_power_spectrum(k,p)
...
#        self.s2_s2_2_P4 = (8*(85*self.xi20**2 + 2*(49*self.xi00 + 50*self.xi20)*self.xi40 + 162*self.xi40**2))/77175.
        ...
        self.s2_s2_0_P0 = (2*(75*self.J6**2 + 4*self.J7**2 + 56*self.J7*self.J8 + 63*self.J8**2 + 8*self.J7*self.J9 + 22*self.J8*self.J9 + 2*self.J9**2 + 4*self.J5*(15*self.J6 + 10*self.J8 + self.J9) + 2*self.J6*(20*self.J7 + 50*self.J8 + 7*self.J9)))/15.
  
        self.s2_s2_0_P2 = (4*(4*self.J7**2 + 4*self.J5*(7*self.J8 + self.J9) + (3*self.J8 + self.J9)*(13*self.J8 + 2*self.J9) + self.J7*(44*self.J8 + 8*self.J9) + self.J6*(28*self.J7 + 49*self.J8 + 11*self.J9)))/21.
 
        self.s2_s2_0_P4 = (24*(2*self.J7**2 + 2*(self.J5 + self.J6)*self.J9 + 4*self.J7*(2*self.J8 + self.J9) + (3*self.J8 + self.J9)**2))/35. 

        self.s2_s2_1_P0 = (-4*(75*self.J6**2 + 4*self.J7**2 + 56*self.J7*self.J8 + 63*self.J8**2 + 8*self.J7*self.J9 + 22*self.J8*self.J9 + 2*self.J9**2 + 4*self.J5*(15*self.J6 + 10*self.J8 + self.J9) + 2*self.J6*(20*self.J7 + 50*self.J8 + 7*self.J9)))/15.
 
        self.s2_s2_1_P2 = (-4*(4*self.J7**2 + 4*self.J5*(7*self.J8 + self.J9) + (3*self.J8 + self.J9)*(13*self.J8 + 2*self.J9) + self.J7*(44*self.J8 + 8*self.J9) + self.J6*(28*self.J7 + 49*self.J8 + 11*self.J9)))/21.

        self.s2_s2_1_P4 = (32*(2*self.J7**2 + 2*(self.J5 + self.J6)*self.J9 + 4*self.J7*(2*self.J8 + self.J9) + (3*self.J8 + self.J9)**2))/35. 

        self.s2_s2_2_P0 = (4*(75*self.J6**2 + 4*self.J7**2 + 56*self.J7*self.J8 + 63*self.J8**2 + 8*self.J7*self.J9 + 22*self.J8*self.J9 + 2*self.J9**2 + 4*self.J5*(15*self.J6 + 10*self.J8 + self.J9) + 2*self.J6*(20*self.J7 + 50*self.J8 + 7*self.J9)))/15.
 
        self.s2_s2_2_P2 = (-8*(4*self.J7**2 + 4*self.J5*(7*self.J8 + self.J9) + (3*self.J8 + self.J9)*(13*self.J8 + 2*self.J9) + self.J7*(44*self.J8 + 8*self.J9) + self.J6*(28*self.J7 + 49*self.J8 + 11*self.J9)))/21.

        self.s2_s2_2_P4 = (8*(2*self.J7**2 + 2*(self.J5 + self.J6)*self.J9 + 4*self.J7*(2*self.J8 + self.J9) + (3*self.J8 + self.J9)**2))/35.
    ...
    def ggm0_integrals(self,k):
        ...
        ret = np.zeros(self.num_gg_components)
        ...
        for l in range(self.jn):
            ...
            P3fac = 0.5 * (5*mu3fac - 3*mu1fac)
            P4fac = 1./8 * (35*mu4fac - 30*mu2fac + 3); mu2P4fac = 1./8 * (35*mu6fac - 30*mu4fac + 3*mu2fac)
            P5fac = 1./8 * (63*mu5fac - 70*mu3fac + 15*mu1fac)
            
            # (s_ab, s_cd)
            bias_integrands[0,:] = (1 - 0.5*ksq*self.Xlin_gt)*(2./15*self.xi00-4./21*self.xi20*P2fac+12./35*self.xi40*P4fac) \
                - 0.5 * ksq * self.Ylin_gt * (2/15*self.xi00*mu2fac -4./21*self.xi20*mu2P2fac+12./35*self.xi40*mu2P4fac)\
                - ksq * (1.5*self.J4**2*mu6fac + (4*self.J3*self.J4-self.J4**2)*mu4fac +   1./6*(16*self.J3**2-8*self.J3*self.J4+self.J4**2)*mu2fac ) \
                - k * ( self.s_s_0_P1*mu1fac + self.s_s_0_P3*P3fac + self.s_s_0_P5 * P5fac  )
                
            # (s_ab, delta s_cd)
            bias_integrands[1,:] = - k*(self.s_ds_0_P1 * P1fac + self.s_ds_0_P3 * P3fac + self.s_ds_0_P5 * P5fac)
            
            # (s_ab, s^2_cd)
            bias_integrands[2,:] = - k*(self.s_s2_0_P1 * P1fac + self.s_s2_0_P3 * P3fac + self.s_s2_0_P5 * P5fac)
            
            # (s_ab, L2_cd)
            bias_integrands[3,:] =  - k * ( self.s_L2_0_P1*mu1fac + self.s_L2_0_P3*P3fac + self.s_L2_0_P5 * P5fac  )
            
            # (delta s_ab, delta s_cd)
            bias_integrands[4,:] = self.ds_ds_0_P0 + self.ds_ds_0_P2 * P2fac + self.ds_ds_0_P4 * P4fac # hack
            
            # (delta s_ab, s^2_cd)
            bias_integrands[5,:] = self.ds_s2_0_P0 + self.ds_s2_0_P2 * P2fac + self.ds_s2_0_P4 * P4fac
            
            # (delta s_ab, L2_cd)
            bias_integrands[6,:] = -(2./15*self.xi0_Q2ds -4./21*self.xi2_Q2ds*P2fac+12./35*self.xi4_Q2ds*P4fac)
            
            # (s^2_ab, s^2_cd)
            bias_integrands[7,:] = self.s2_s2_0_P0 + self.s2_s2_0_P2 * P2fac + self.s2_s2_0_P4 * P4fac
            
            # (s^2_ab, L2_cd)
            bias_integrands[8,:] = -(2./15*self.xi0_Q2s2 -4./21*self.xi2_Q2s2*P2fac+12./35*self.xi4_Q2s2*P4fac)            
            # (L^2_ab, L^2_cd)
            bias_integrands[9,:] = -(2./15*self.xi0_Q2L2 -4./21*self.xi2_Q2L2*P2fac+12./35*self.xi4_Q2L2*P4fac) 
            # Cubic Terms
            bias_integrands[10,:] = 2./15*self.xi00_b3-4./21*self.xi20_b3*P2fac+12./35*self.xi40_b3*P4fac # b3 = 4/7 R1
            
            bias_integrands[11,:] = 2./15*self.xi00_dt-4./21*self.xi20_dt*P2fac+12./35*self.xi40_dt*P4fac # (s, delta t)
            
            # Linear term for counterterm
            bias_integrands[12,:] = ksq * (2./15*self.xi00-4./21*self.xi20*P2fac+12./35*self.xi40*P4fac)
    ...
    def ggm1_integrals(self,k):
        ...
        for l in range(self.jn):
            ...
            # (s_ab, s_cd)
            bias_integrands[0,:] = (1 - 0.5*ksq*self.Xlin_gt)*(-4./15*self.xi00+4./21*self.xi20*P2fac+16./35*self.xi40*P4fac) \
               - 0.5* ksq * self.Ylin_gt * (-4/15*self.xi00*mu2fac+4./21*self.xi20*mu2P2fac+16./35*self.xi40*mu2P4fac)\
               -ksq * ( -2*self.J3**2 + 2*(self.J3**2-2*self.J3*self.J4)*mu2fac + 2*(2*self.J3*self.J4-self.J4**2)*mu4fac + 2*self.J4**2*mu6fac ) \
               - k * ( self.s_s_1_P1*mu1fac + self.s_s_1_P3*P3fac + self.s_s_1_P5 * P5fac  )
               
            # (s_ab, delta s_cd)
            bias_integrands[1,:] = - k*(self.s_ds_1_P1 * P1fac + self.s_ds_1_P3 * P3fac + self.s_ds_1_P5 * P5fac)
            
            # (s_ab, s^2_cd)
            bias_integrands[2,:] = - k*(self.s_s2_1_P1 * P1fac + self.s_s2_1_P3 * P3fac + self.s_s2_1_P5 * P5fac)
            
            # (s_ab, L2_cd)
            bias_integrands[3,:] = - k * ( self.s_L2_1_P1*mu1fac + self.s_L2_1_P3*P3fac + self.s_L2_1_P5 * P5fac  )
            
            # (delta s_ab, delta s_cd)
            bias_integrands[4,:] = self.ds_ds_1_P0 + self.ds_ds_1_P2 * P2fac + self.ds_ds_1_P4 * P4fac
            
            # (delta s_ab, s^2_cd)
            bias_integrands[5,:] = self.ds_s2_1_P0 + self.ds_s2_1_P2 * P2fac + self.ds_s2_1_P4 * P4fac
            
            # (delta s_ab, L2_cd)
            bias_integrands[6,:] = -(-4/15*self.xi0_Q2ds +4./21*self.xi2_Q2ds*P2fac +16./35*self.xi4_Q2ds*P4fac) 
            
            # (s^2_ab, s^2_cd)
            bias_integrands[7,:] = self.s2_s2_1_P0 + self.s2_s2_1_P2 * P2fac + self.s2_s2_1_P4 * P4fac
            
            # (s^2_ab, L2_cd)
            bias_integrands[8,:] = -(-4/15*self.xi0_Q2s2 +4./21*self.xi2_Q2s2*P2fac +16./35*self.xi4_Q2s2*P4fac) 
            
            # (L^2_ab, L^2_cd)
            bias_integrands[9,:] = -(-4/15*self.xi0_Q2L2 +4./21*self.xi2_Q2L2*P2fac +16./35*self.xi4_Q2L2*P4fac) 

            # Cubic Terms
            bias_integrands[10,:] = -4./15*self.xi00_b3+4./21*self.xi20_b3*P2fac+16./35*self.xi40_b3*P4fac # b3 = 4/7 R1
            
            bias_integrands[11,:] = -4./15*self.xi00_dt+4./21*self.xi20_dt*P2fac+16./35*self.xi40_dt*P4fac # (s, delta t)
            
            # Linear term for counterterm
            bias_integrands[12,:] = ksq * (-4./15*self.xi00+4./21*self.xi20*P2fac+16./35*self.xi40*P4fac)
    ...
    def ggm2_integrals(self,k):
        ...
        for l in range(self.jn):
            ...
            # (s_ab, s_cd)
            bias_integrands[0,:] = (1 - 0.5*ksq*self.Xlin_gt)*(4./15*self.xi00+8./21*self.xi20*P2fac+4./35*self.xi40*P4fac) \
             - 0.5*ksq*self.Ylin_gt*(4/15*self.xi00*mu2fac+8./21*self.xi20*mu2P2fac+4./35*self.xi40*mu2P4fac)\
             - ksq * self.J4**2 * (0.5*mu2fac - mu4fac + 0.5*mu6fac) \
            - k * ( self.s_s_2_P1*mu1fac + self.s_s_2_P3*P3fac + self.s_s_2_P5 * P5fac  )

            # (s_ab, delta s_cd)
            bias_integrands[1,:] = - k*(self.s_ds_2_P1 * P1fac + self.s_ds_2_P3 * P3fac + self.s_ds_2_P5 * P5fac)
            
            # (s_ab, s^2_cd)
            bias_integrands[2,:] = - k*(self.s_s2_2_P1 * P1fac + self.s_s2_2_P3 * P3fac + self.s_s2_2_P5 * P5fac)
            
            # (s_ab, L2_cd)
            bias_integrands[3,:] = - k * ( self.s_L2_2_P1*mu1fac + self.s_L2_2_P3*P3fac + self.s_L2_2_P5 * P5fac  )
            
            # (delta s_ab, delta s_cd)
            bias_integrands[4,:] = self.ds_ds_2_P0 + self.ds_ds_2_P2 * P2fac + self.ds_ds_2_P4 * P4fac
            
            # (delta s_ab, s^2_cd)
            bias_integrands[5,:] = self.ds_s2_2_P0 + self.ds_s2_2_P2 * P2fac + self.ds_s2_2_P4 * P4fac
            
            # (delta s_ab, L2_cd)
            bias_integrands[6,:] = -(4/15*self.xi0_Q2ds + 8./21*self.xi2_Q2ds*P2fac + 4./35*self.xi4_Q2ds*P4fac) 
            
            # (s^2_ab, s^2_cd)
            bias_integrands[7,:] = self.s2_s2_2_P0 + self.s2_s2_2_P2 * P2fac + self.s2_s2_2_P4 * P4fac
            
            # (s^2_ab, L2_cd)
            bias_integrands[8,:] = -(4/15*self.xi0_Q2s2 + 8./21*self.xi2_Q2s2*P2fac + 4./35*self.xi4_Q2s2*P4fac) 
            
            # (L^2_ab, L^2_cd)
            bias_integrands[9,:] = -(4/15*self.xi0_Q2L2 + 8./21*self.xi2_Q2L2*P2fac + 4./35*self.xi4_Q2L2*P4fac)
            
            # Cubic Terms
            bias_integrands[10,:] = 4./15*self.xi00_b3+8./21*self.xi20_b3*P2fac+4./35*self.xi40_b3*P4fac # b3 = 4/7 R1
            
            bias_integrands[11,:] = 4./15*self.xi00_dt+8./21*self.xi20_dt*P2fac+4./35*self.xi40_dt*P4fac # (s, delta t)
            
            # Linear term for counterterm
            bias_integrands[12,:] = ksq * (4./15*self.xi00+8./21*self.xi20*P2fac+4./35*self.xi40*P4fac)
    ...
    def make_ggtable(self, m, kmin = 1e-3, kmax = 3, nk = 100):
        ...
        for foo in range(nk):
            if m == 0:
                pktable[foo,1:] = self.ggm0_integrals(kv[foo])
            if m == 1:
                pktable[foo,1:] = -0.5 * self.ggm1_integrals(kv[foo])
            if m == 2:
                pktable[foo,1:] = 0.5 * self.ggm2_integrals(kv[foo])
