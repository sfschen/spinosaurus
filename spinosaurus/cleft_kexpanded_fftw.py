...
class KECLEFT:
    ...
    def __init__(self, k, p, one_loop=True, shear=True, third_order= True, cutoff=20, jn=5, N = 4000, threads=1, extrap_min = -4, extrap_max = 3, import_wisdom=False, wisdom_file=None):
    ...
    def make_ptable(self, D = 1, nonlinear=1, kmin = 1e-3, kmax = 3, nk = 100):
        '''
